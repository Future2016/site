...
<head>
    ...
    <title><?php echo "Future2016"; ?></title>
    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1 id="firsthead">Where the future is born.</h1>
                <hr>
                <p id="tl">Belfast, 12th-13th February 2016</p>
                <a href="tickets" id="home_btn_main" class="btn btn-primary btn-xl page-scroll">TICKETS NOW AVAILABLE</a>
            </div>
        </div>
    </header>
